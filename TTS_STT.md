[cite_start]제공해주신 시간표에 따르면 **7주차와 8주차(5월 11일 ~ 5월 22일)**에 '음성 데이터 활용한 TTS와 STT 모델 개발' 과정이 예정되어 있습니다[cite: 10]. 실습에 앞서 Python의 대표적인 라이브러리를 활용해 TTS(Text-to-Speech)와 STT(Speech-to-Text)를 간단히 구현하는 기초 코드를 작성해 드립니다.
